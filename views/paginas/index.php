<div class="video">
        ...
        <video autoplay muted loop>
            <source src="build/img/tienda/<?php echo nombreRandom() ?>.mp4" type="video/mp4" />
        </video>
    </div>
    ...
    <main class="contenedor seccion">
        ...
        <div class="contenido-nosotros">
            <div class="imagen">
                <picture>
                    <source srcset="build/img/nosotros/oficina.webp" type="image/webp" />
                    <source srcset="build/img/tienda/oficina.jpg" type="image/jpeg" />
                    <img loading="lazy" src="build/img/tienda/oficina.jpg" alt="oficina" />
                </picture>
            </div>
